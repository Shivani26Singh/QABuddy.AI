# QABuddy.AI — Hybrid RAG Knowledge Engine for QA Teams

Ask anything. Get a **cited** answer backed by your actual QA assets — frameworks,
test cases, JIRA tickets, PRDs, meeting transcripts, and CI logs — all instantly searchable.
...
![QABuddy home](qabuddy-home.png)

Cited answer with multiple source types referenced (meeting + JIRA + Lucid + code with line numbers):

![QABuddy cited answer](qabuddy-cited-answer.png)
