...
SOURCES = {
    "01": dict(folder="01_selenium_framework", source_type="selenium_framework",
               label="Selenium framework", loader="code", repo="QABuddy-Selenium-Framework",
               git="https://github.com/shivani26Singh/AI.git"),
    "02": dict(folder="02_playwright_framework", source_type="playwright_framework",
               label="Playwright framework", loader="code", repo="QABuddy-Playwright-Framework",
               git="https://github.com/shivani26Singh/AI.git"),
    ...
    "06": dict(folder="06_figma_designs", source_type="figma_designs",
               label="Figma designs", loader="docs"),
